...
global.sprSkillIconMini = sprite_add("../Sprites/Loner Icon Mini.png", 1, 4, 4)
global.sprSkillHUD = sprite_add("../Sprites/Icons/Loner Icon.png", 1, 8, 8)
global.sprTipEmoji = sprite_add("../Sprites/Loner tip emoji.png", 1, 5, 3)
global.chosen = [];
global.skill = [];
...
#define skill_tip
	return `EVERYONE IS SO MEAN 2 ME @(${global.sprTipEmoji})`;
