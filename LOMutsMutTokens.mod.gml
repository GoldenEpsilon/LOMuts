#define init
	...
	/*global.shopOptions = [
		...
		//{name: "REBEL", text: "LOSE AN OUTCAST MUTATION#GAIN AN OUTCAST MUTATION", cost: 2, icon: global.spr_blank, on_select: script_ref_create(tokenshop_rebel)},
		...
		//{name: "DECIDE", text: "LOSE 1 MUTATION#GAIN ONE MUTATION OUT OF ALL MUTATIONS", cost: 5, icon: global.spr_blank, on_select: script_ref_create(tokenshop_decide)},
