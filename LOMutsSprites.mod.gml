...
lq_set(global.sprites, "Neural Network", [sprite_add("Sprites/Main/Neural Network.png", 1, 12, 16)]);
lq_set(global.sprites, "Deep Convolutional Network", [sprite_add("Sprites/Main/Neural Network/Deep Convolutional Network.png", 1, 12, 16)]);
lq_set(global.sprites, "Deep Residual Network", [sprite_add("Sprites/Main/Neural Network/Deep Residual Network.png", 1, 12, 16)]);
lq_set(global.sprites, "Echo State Network", [sprite_add("Sprites/Main/Neural Network/Echo State Network.png", 1, 12, 16)]);
lq_set(global.sprites, "Feed Forward Network", [sprite_add("Sprites/Main/Neural Network/Feed Forward Network.png", 1, 12, 16)]);
lq_set(global.sprites, "Generative Adversarial Network", [sprite_add("Sprites/Main/Neural Network/Generative Adversarial Network.png", 1, 12, 16)]);
lq_set(global.sprites, "Markov Chain", [sprite_add("Sprites/Main/Neural Network/Markov Chain.png", 1, 12, 16)]);
lq_set(global.sprites, "Recurrent Neural Network", [sprite_add("Sprites/Main/Neural Network/Recurrent Neural Network.png", 1, 12, 16)]);
lq_set(global.sprites, "Support Vector Machines", [sprite_add("Sprites/Main/Neural Network/Support Vector Machines.png", 1, 12, 16)]);
